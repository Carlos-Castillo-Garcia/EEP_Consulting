...
public class ImplServicios implements DatosService {
    File archivo = new File("D:\\MUY_IMPORTANTE\\Clase\\Repositorios\\EEP_Consulting\\src\\main\\java\\com\\eep\\EEP_Consulting\\Repository\\Camioneros.txt");
    ...
    @Override
    public String ModificacionCamioneros(Camionero nombre) {
        FileReader fr = null;
        BufferedReader br = null;
        String contenido;
        File outputFile = new File(archivo.getAbsolutePath()+".temp");
